...
- Is this network more structured than chance?

    - Do some students receive more nominations?
    - Are friendships reciprocated?
    - Do friends of friends tend to be friends?
---
## How can we tell if a network formed as a result of social processes?

- We observe one friendship network.

- Some patterns may arise simply because the network has 73 actors and 243 edges.

- We need a baseline model before calling a pattern substantively meaningful.

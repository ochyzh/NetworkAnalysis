...
If you can get all your friends to meet you at the entrance to the IRS building in exactly 1 hour, you will win $1,000,000. The catch is that you can only contact one friend, and not all your friends know each other. The picture below is a visualization of your friendship network. Which friend would you call and why?
...
- Who should you call if you want the message to spread fastest?

- Who should you call if you want as many people as possible to hear it directly?

- Who should you remove to stop the message from spreading?
...
---
## Centrality depends on what you mean by important

| If I care about           | Use         |
| ------------------------- | ----------- |
| popularity                | Degree      |
| reaching everyone quickly | Closeness   |
| controlling communication | Betweenness |
...
## Comparison of these measures (Arifuzzaman & Bhuiyan)
...
Which Google page is more important?

- 100 random pages → A

- President's White House page → B
---
...
- Degree is purely local.

    - It ignores everything beyond immediate neighbors.

- Closeness and betweenness assume information follows shortest paths.
...
- Calculate the four types of centrality for the fictitious friend network we've worked with. Did they match your expectations?

- Plot the network so that the nodes are proportionate in size to different types of centrality.
